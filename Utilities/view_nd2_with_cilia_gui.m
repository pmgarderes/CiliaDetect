...
% Add a push button on the right side
btn1 = uicontrol('Style', 'pushbutton', ...
                 'String', 'Button 1', ...
                 'Units', 'normalized', ...
                 'Position', [0.85, 0.7, 0.1, 0.05], ...
                 'Callback', @(src, event) disp('Button 1 clicked'));

% Add another push button below the first one
btn2 = uicontrol('Style', 'pushbutton', ...
                 'String', 'Button 2', ...
                 'Units', 'normalized', ...
                 'Position', [0.85, 0.6, 0.1, 0.05], ...
                 'Callback', @(src, event) disp('Button 2 clicked'));
